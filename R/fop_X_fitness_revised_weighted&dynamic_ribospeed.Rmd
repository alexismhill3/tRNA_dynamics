...
opt_val <- 1.0
nonopt_val <- 0.25
weighted_output_dir <- sprintf("../data/simulation/revised_weighted_opt%.1f_nonopt%.2f", opt_val, nonopt_val)
...
if (SAVE_FIGS) {
  save_plot(sprintf("fig/revised_fopXfitness_weighted_opt%.1f_nonopt%.2f_dynamic_ribospeed%.1f.pdf", opt_val, nonopt_val, ribo_speed), combined_plot, base_width = 10, base_height = 8)
}
```

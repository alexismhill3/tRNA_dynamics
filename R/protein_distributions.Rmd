...
```{r}
fop <- 0.7 # near WT fop
# Final fitted weights are 12 and 5.2 for opt and non-opt codons, respectively
...
base_dir <- "../data/simulation/revised_weighted_opt12.0_nonopt5.2/"
seeds <- c(70, 38, 79, 4, 80, 84, 27, 33, 7, 51)
weighted_data_07 <- NULL
for (seed in seeds) {
  tmp <- load_sim(paste0(base_dir,"weighted_opt12.0_nonopt5.2_",seed,"_fop",fop,".tsv"))
